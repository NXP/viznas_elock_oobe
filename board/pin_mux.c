...
void BOARD_InitAudio(void) {
    ...
    IOMUXC_SetPinConfig(
      IOMUXC_GPIO_B0_12_SAI1_TX_DATA01,       /* GPIO_B0_12 PAD functional properties : */
            0xF0B0U); // OK: 22K pull-up, Pull, Enabled, Disabled, 100MHz, R0/6, Slow
//      0xF090U); // OK: 22k pull-up, Pull, enabled, Disabled, 100MHz, R0/2, Slow
//          0x3090U); // noise: 100K pull-up, Pull, Enabled, Disabled, 100MHz, R0/2, Slow
}
