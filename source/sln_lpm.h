...
/* Define of operation, board can not enter sleep mode. */
typedef enum
{
    LPM_DetNoFaceTimeout = 0,
    LPM_RecNoFaceTimeout,
    LPM_LockState,
    LPM_ButtonOperation,
    LPM_BleRemoteTransmit,
    LPM_WifiRemoteTransmit,
    LPM_EnterSuspendReady,
    LPM_LastOperation,
} lpm_control_type_t;
/*******************************************************************************
 * API
