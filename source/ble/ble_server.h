...
typedef enum
{
    ...
    /* Uart Service */
    HANDLE_UART_SERVICE = 0x60,
    HANDLE_UART_SERVICE_CHAR_WRITE,
    HANDLE_UART_SERVICE_CHAR_WRITE_VAL,
    HANDLE_UART_SERVICE_CHAR_NOTIFY,
    HANDLE_UART_SERVICE_CHAR_NOTIFY_VAL,
    HANDLE_UART_SERVICE_CHAR_CFG_DESC,
...
/**
 * @brief Returns the ble connect status
 *
 */
