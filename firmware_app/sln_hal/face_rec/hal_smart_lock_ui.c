...
const static char *s_uiStrResources[] = {
    {"��������"},        // kUIStrID_Smartlock
    {"�Ž� 2D"},         // kUIStrID_Access2D
    {"��ע���û�:%d"},   // kUIStrID_RegisteredUsers
    {"ʶ��ɹ�"},        // kUIStrID_RecognitionSuccessful
    {"ʶ��ʧ��"},        // kUIStrID_RecognitionFailed
    {"���幥��"},        // kUIStrID_Fakeface
    {"����ע��"},        // kUIStrID_Registering
    {"ע��ɹ�"},        // kUIStrID_RegistrationSuccessful
    {"%s ��ӳɹ�"},     // kUIStrID_NameAdded
    {"�û��Ѵ���"},      // kUIStrID_UserAlreadyExists
    {"%s �Ѵ���"},       // kUIStrID_NameExists
    {"ע�ᳬʱ"},        // kUIStrID_RegistrationTimeout
    {"����ɾ��"},        // kUIStrID_Deregistering
    {"\"%s\" ɾ���ɹ�"}, // kUIStrID_NameRemoved
    {"ɾ����ʱ"},        // kUIStrID_DeregistrationTimeout
    {"����¼��..."}      // kUIStrID_Recording
};
#else
const static char *s_uiStrResources[] = {
