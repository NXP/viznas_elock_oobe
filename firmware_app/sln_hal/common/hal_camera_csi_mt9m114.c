...
const static camera_dev_operator_t s_CameraDev_CsiMt9m114Ops = {
...
int HAL_CameraDev_CsiMt9m114_Register(camera_dev_static_config_t *config)
{
    int error = 0;
    LOGD("HAL_CameraDev_CsiMt9m114_Register");

    memcpy(&(s_CameraDevCsi_Mt9m114.config), config, sizeof(camera_dev_static_config_t));
