...
static hal_camera_status_t HAL_CameraDev_FlexioGc0308_InputNotify(const camera_dev_t *dev, void *data)
{
...
const static camera_dev_operator_t s_CameraDev_FlexioGc0308Ops = {
    ...
    .inputNotify = HAL_CameraDev_FlexioGc0308_InputNotify,
};
...
int HAL_CameraDev_FlexioGc0308_Register(camera_dev_static_config_t *config)
{
    ...
    memcpy(&(s_CameraDev_FlexioGc0308.config), config, sizeof(camera_dev_static_config_t));
