...
#else
#define USB_INTERFACE_COUNT_USB     (USB_VIDEO_VIRTUAL_CAMERA_INTERFACE_COUNT)
#endif

#define USB_INTERFACE_COUNT_DISPLAY USB_CDC_VCOM_INTERFACE_COUNT
#define USB_INTERFACE_COUNT         ((Cfg_AppDataGetOutputMode()== DISPLAY_USB) ? USB_INTERFACE_COUNT_USB : USB_INTERFACE_COUNT_DISPLAY)
...
#else
#define USB_VIDEO_VIRTUAL_CAMERA_CONTROL_INTERFACE_INDEX (0)
#endif
...
#define USB_VIDEO_VIRTUAL_CAMERA_MJPEG_FRAME_WIDTH (LCD_WIDTH)
#define USB_VIDEO_VIRTUAL_CAMERA_MJPEG_FRAME_HEIGHT (LCD_HEIGHT)
