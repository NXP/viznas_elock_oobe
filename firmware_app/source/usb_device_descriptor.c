...
const
uint8_t g_UsbDeviceString2[] = {2U + 2U * 10U, USB_DESCRIPTOR_TYPE_STRING,
								'S',           0,
								'L',           0,
								'N',           0,
        						'-',           0,
...
usb_status_t USB_RegisterCDC2()
{
	...
	{
	   ptr2 = (usb_descriptor_configuration_t *)descriptorHead;
	   memcpy(g_UsbDeviceConfigurationDescriptor + s_total_size, g_UsbCDC2Configuration, sizeof(g_UsbCDC2Configuration));
