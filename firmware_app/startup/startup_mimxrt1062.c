...
extern void __base_SRAM_OCRAM_CACHED(void);
extern void __top_SRAM_OCRAM_CACHED(void);
extern void __base_SRAM_OCRAM_NCACHED(void);
extern void __top_SRAM_OCRAM_NCACHED(void);
...
void map_flexram(void)
{
    ...
    unsigned int ocSize_non_cacheable = (unsigned int)__top_SRAM_OCRAM_NCACHED - (unsigned int)__base_SRAM_OCRAM_NCACHED;
    unsigned int ocSize_cacheable = (unsigned int)__top_SRAM_OCRAM_CACHED - (unsigned int)__base_SRAM_OCRAM_CACHED;
...
#define SAFE_STACK_TOP (0x20208000) // Temporary stack pointer to end of first block of SRAM OC (always there)
