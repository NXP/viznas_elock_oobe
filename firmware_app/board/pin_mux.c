...
void BOARD_InitCsiCameraPins(void) {
    ...
    IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_12_LPI2C4_SCL, 0x98B0U);
    IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_13_LPI2C4_SDA, 0x98B0U);
}
...
void BOARD_InitFlexioCameraPins(void)
{
    ...
    IOMUXC_SetPinMux(IOMUXC_GPIO_AD_31_FLEXIO2_D31,     /* GPIO_AD_31 is configured as FLEXIO2_D31 */
                     0U); /* Software Input On Field: Input Path is determined by functionality */
    /* MCLK */
    IOMUXC_SetPinMux(IOMUXC_GPIO_AD_09_FLEXIO2_D09,     /* GPIO_AD_09 is configured as FLEXIO2_D09 */
                     0U); /* Software Input On Field: Input Path is determined by functionality */
    /* XCLK */
    IOMUXC_SetPinMux(IOMUXC_GPIO_AD_10_FLEXIO2_D10,     /* GPIO_AD_10 is configured as FLEXIO2_D10 */
                     0U); /* Software Input On Field: Input Path is determined by functionality */
    /* HSYNC */
    IOMUXC_SetPinMux(IOMUXC_GPIO_AD_11_FLEXIO2_D11,     /* GPIO_AD_11 is configured as FLEXIO2_D11 */
                     0U); /* Software Input On Field: Input Path is determined by functionality */

    /* VSYNC */
#ifdef USE_DISP_B2_14_AS_FLEXIO_CAMERA_VSYNC
    // Hardware workaround to switch the vsync to IOMUXC_GPIO_DISP_B2_14_GPIO_MUX5_IO15
    IOMUXC_SetPinMux(IOMUXC_GPIO_DISP_B2_14_GPIO_MUX5_IO15, /* GPIO_DISP_B2_14 is configured as GPIO_MUX5_IO15 */
                     0U);
#else
    ...
    IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B2_04_GPIO10_IO13,  /* GPIO_SD_B2_04 is configured as GPIO10_IO13 */
                     0U); /* Software Input On Field: Input Path is determined by functionality */
    /* RESET */
    IOMUXC_SetPinMux(IOMUXC_GPIO_SNVS_02_DIG_GPIO13_IO05, /* GPIO_SNVS_02 is configured as GPIO13_IO05 */
                     0U); /* Software Input On Field: Input Path is determined by functionality */
...
void BOARD_InitElcdifRk043fn02hLcdPins(void)
{
    CLOCK_EnableClock(kCLOCK_Iomuxc);
...
void BOARD_InitButtonPins(void)
{
    ...
    /* Pull Up / Down Config. Field: 100K Ohm Pull Up */
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_07_GPIO2_IO23, 0xB8B0U);
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_08_GPIO2_IO24, 0xB8B0U);
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_10_GPIO2_IO26, 0xB8B0U);
...
void BOARD_InitFlash(void) {
  ...
  IOMUXC_SetPinConfig(
      ...
      0x013088U);                             /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0(150 Ohm @ 3.3V, 260 Ohm@1.8V)
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
                                                 Pull / Keep Enable Field: Pull/Keeper Enabled
